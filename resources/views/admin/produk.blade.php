...
@section('content')
    ...
    <button type="button" id="addProduk" class="btn btn-primary mb-3 mt-3" data-bs-toggle="modal"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="harga_beli" id="harga_beli"
                                    data-a-sign="Rp. " data-a-dec="," data-a-sep="." aria-label="Harga Beli">
                            </div>
                            <div class="col">
            ...
            $('body').on('click', '#btn-edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#kategori').html('<option value = "' + response.data.kategori.id +
                            '" selected>' + response.data.kategori.nama + '</option>');
                        $('#supplier').html('<option value = "' + response.data.supplier.id +
                            '" selected>' + response.data.supplier.nama + '</option>');
